...
#in this example, the names of F and R file are the following: NGS006-22-EXP5-16S-SAMPLENAME_yyy-R1_001.fastq.gz
...
out =filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(269,215),
...
#5) CUTADAPT: primer removal from F and R reads---------------------------------------------------
...
#7) MERGE SEQTABS OBTAINED FROM DIFFERENT SEQUENCING RUNS--------------------------------------------
#(skip this step if you included all the samples in one sequencing run. In that case, go to step8)
...
#9)CHECK THE NUMBER OF SEQUENCES RETAINED IN EACH STEP OF THE PROCESSING
...
#12) MOCK COMMUNITY QUALITY CONTROL--------------------------------------------------
...
#13) REMOVAL OF PLASTIDS, PLANT, CHLOROPLAST AND OTHER ARTIFACTS SEQUENCES
