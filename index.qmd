...
This repository contains different scripts: those related to the DNA sequencing for fungal an bacterial datasets, and other related to the preparation and standardization of the data to the DarwinCore Archive to integtrate the data into GBIF

## Sequencing data
These scripts explain all the steps the steps from the fastq files to a filtered ASV table.
...
# Processing of Illumina MiSeq sequencing reads (16S V3-V4 and ITS2)
...
## Authors
- Ana V Lasa  <a href="https://orcid.org/0000-0003-3783-7157" target="orcid.widget">
